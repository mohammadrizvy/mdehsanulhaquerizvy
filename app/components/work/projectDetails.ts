import {
  ...
  SiMongodb, 
  SiNeovim,
  SiNextdotjs, SiNextui, // Placeholder icon for Next UI
  SiReact,
  SiRust,
  SiTailwindcss,
  SiTypescript,
...
export const projects: ProjectProps[] = [
  {
    ...
    technologies: [SiReact, SiTailwindcss, SiFirebase, SiJsonwebtokens, SiMongodb],
  ...
  },
  {
    id: 1,
    name: "chic.stylin",
    description: "chic.stylin is a React-based shopping website that provides a seamless and engaging online shopping experience, featuring a wide range of products and user-friendly navigation.",
